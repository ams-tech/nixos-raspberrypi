...
stdenvNoCC.mkDerivation (finalAttrs: {
  ...
  installPhase = ''
    mkdir -p "$out/bin"
    cp rpi-eeprom-config rpi-eeprom-update rpi-eeprom-digest tools/rpi-otp-private-key "$out/bin"
  ...
  fixupPhase = ''
    ...
    for i in rpi-eeprom-update rpi-eeprom-config rpi-otp-private-key; do
